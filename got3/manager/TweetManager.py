import urllib.request, urllib.parse,urllib.parse,json,re,datetime,sys,http.cookiejar
from .. import models
...
class TweetManager:
	...
	def getTweets(tweetCriteria, receiveBuffer=None, bufferLength=100, proxy=None):
		...
		# get username or search word

		try:
			name = tweetCriteria.querySearch
		except :
			name = tweetCriteria.username
		...
		while active:
			...
			for tweetHTML in tweets:
				...
				usernameTweet = tweetPQ("span.username").text()
